...
# Check if replacements need to be made by searching for old text segments
if "models_pytorch/phi3-mini" in content and "models_fp16/phi3-mini-fp16.mlpackage" not in phi3_old:
    print("Found old phi3 block, replacing...")
    content = content.replace(phi3_old, phi3_new)
    
if "models_pytorch/llama32-3b" in content:
    print("Found old llama block, replacing...")
